  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      <div className="glass rounded-[3rem] shadow-2xl overflow-hidden border-white/60">
        ...
        <div className="p-12 relative min-h-[500px]">
          <AnimatePresence mode="wait">
            {step === 1 && (
              <motion.div 
                ...
                exit="exit"
              >
                <motion.span variants={itemVariants} className="bg-indigo-100 text-indigo-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest inline-block">Step 01</motion.span>
                <motion.h2 variants={itemVariants} className="text-4xl font-black text-slate-800 mt-4 mb-2">Identify Yourself</motion.h2>
                <motion.p variants={itemVariants} className="text-slate-500 font-medium mb-10">We tailor flow-x suggestions based on your daily grind.</motion.p>
            ...
            {step === 2 && (
              <motion.div 
                ...
                exit="exit"
              >
                <motion.span variants={itemVariants} className="bg-purple-100 text-purple-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest inline-block">Step 02</motion.span>
                <motion.h2 variants={itemVariants} className="text-4xl font-black text-slate-800 mt-4 mb-2">Select Working Days</motion.h2>
                <motion.p variants={itemVariants} className="text-slate-500 font-medium mb-10">When are you officially in the zone?</motion.p>
                ...
                <motion.div variants={itemVariants} className="flex space-x-4 mt-12">
            ...
            {step === 3 && (
              <motion.div 
                ...
                exit="exit"
              >
                <motion.span variants={itemVariants} className="bg-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest inline-block">Step 03</motion.span>
                <motion.h2 variants={itemVariants} className="text-4xl font-black text-slate-800 mt-4 mb-2">Prime Hours</motion.h2>
                <motion.p variants={itemVariants} className="text-slate-500 font-medium mb-10">Define your focus blocks. flow-x won't interrupt these.</motion.p>
                ...
                <motion.div variants={itemVariants} className="bg-emerald-50 p-6 rounded-[2rem] border border-emerald-100 mt-10">
